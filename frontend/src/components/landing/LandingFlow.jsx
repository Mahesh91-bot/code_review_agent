export default function LandingFlow() {
  return (
    <section
      className="relative overflow-hidden bg-surface-container-lowest py-32"
        ...
        <div className="relative mx-auto flex w-full max-w-5xl flex-col items-center justify-between gap-12 lg:flex-row lg:gap-4">
          <div className="z-10 flex w-full flex-1 flex-col items-center lg:w-48">
            <div className="glass-panel ghost-border glow-shadow relative mb-6 flex h-32 w-full items-center justify-center overflow-hidden rounded-xl p-5">
              <pre className="w-full overflow-hidden font-mono text-[10px] leading-tight text-on-surface-variant">
  ...
  return parse(raw);
          ...
          <div className="hidden w-16 items-center justify-center lg:flex">
            <div className="relative h-1 w-full overflow-hidden rounded-full bg-primary-container/30">
              <div className="animate-pulse-line absolute inset-0 bg-primary-container" />
            </div>
            <span className="material-symbols-outlined z-10 -ml-2 rounded-full text-xl text-primary-container shadow-[0_0_10px_rgba(0,255,65,0.5)]">
              chevron_right
            </span>
          </div>
          <span className="material-symbols-outlined animate-pulse text-2xl text-primary-container lg:hidden lg:rotate-90">
            arrow_downward
          </span>
          <div className="z-10 flex w-full flex-1 flex-col items-center lg:w-48">
            <div className="glass-panel ghost-border glow-shadow relative mb-6 flex h-28 w-28 items-center justify-center rounded-full p-6">
              <div className="absolute inset-0 animate-[ping_3s_ease-in-out_infinite] rounded-full border border-primary-container/40 opacity-50" />
              <span className="material-symbols-outlined text-4xl text-primary-container">
                memory
              </span>
            </div>
            <h4 className="font-display mb-2 text-center text-lg font-bold text-on-surface">
              2. Hindsight Memory
            </h4>
            <p className="text-center font-body text-xs text-on-surface-variant">
          ...
          <div className="hidden w-16 items-center justify-center lg:flex">
            <div className="relative h-1 w-full overflow-hidden rounded-full bg-primary-container/30">
              <div
                className="animate-pulse-line absolute inset-0 bg-primary-container"
          ...
          <span
            className="material-symbols-outlined animate-pulse text-2xl text-primary-container lg:hidden lg:rotate-90"
            style={{ animationDelay: "0.5s" }}
          >
            arrow_downward
          </span>
          <div className="z-10 flex w-full flex-1 flex-col items-center lg:w-48">
            <div className="glass-panel ghost-border glow-shadow mb-6 flex h-32 w-full flex-col items-center justify-center rounded-xl p-5">
              <div className="w-full space-y-2">
                <div className="h-1.5 w-full rounded bg-primary-container/40" />
                <div className="h-1.5 w-3/4 rounded bg-primary-container/70" />
                <div className="h-1.5 w-1/2 rounded bg-primary-container/20" />
              </div>
              <span className="material-symbols-outlined mt-3 animate-bounce text-2xl text-primary-container">
                account_tree
              </span>
            </div>
            <h4 className="font-display mb-2 text-lg font-bold text-on-surface">
          ...
          <div className="z-10 flex w-full flex-1 flex-col items-center lg:w-56">
            <div className="glass-panel ghost-border glow-shadow relative mb-6 flex h-32 w-full flex-col justify-center rounded-xl border-l-2 border-l-primary-container p-4">
              <div className="font-label mb-2 flex items-center text-[10px] uppercase text-primary-container">
